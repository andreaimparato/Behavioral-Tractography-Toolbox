<?php
/*
 Template Name: fromMatlab
* Template Post Type: post, page, product, 3dVisualizer
 *
...
<?php 
$cacheName = $_GET["cache"];
$cachename_clean =  preg_replace( '/[^a-z0-9]/i', '', $cacheName);
//echo $cachename_clean;
?>

	<article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> >
	<script>var jsonObj=<?php  echo file_get_contents( "https://dev.mlnetwork-diplab.ch/cache/".$cachename_clean.".json" ) ?>
	</script>
				<style>
				.header #jsonFile {
					display: none;
